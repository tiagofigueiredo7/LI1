...
p1 = Personagem (0,0) Jogador (5,6) Este (1,1) False False 10 0 (False, 0.0)
...
teste5 = "T5: Jogador colide com limite lateral " ~: True ~=? colisoesParede gameMap1 pl1

pl3 = Personagem (0.0,0.0) Jogador (8.5,0.2) Este (1,1) False False 10 0 (False, 0.0)

teste6 = "T6: Jogador colide com limite superior " ~: True ~=? colisoesParede gameMap1 pl2

pl4 = Personagem (0.0,0.0) Jogador (8.5,2) Este (1,1) False False 10 0 (False, 0.0)

teste7 = "T7: Jogador colide com plataforma " ~: True ~=? colisoesParede gameMap1 pl3
